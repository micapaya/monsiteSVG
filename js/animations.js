...
let ThirdDate = bodymovin.loadAnimation({
	container: document.getElementById('date_2007_2009'),
	renderer: 'svg',
	loop: true,
	autoplay: true,
	path: 'datJSON/test_date/2007_2009.json',
});

let FoursDate = bodymovin.loadAnimation({
	container: document.getElementById('date_2010_2016'),
	renderer: 'svg',
	loop: true,
	autoplay: true,
	path: 'datJSON/test_date/2010_2016.json',
});

let FivesDate = bodymovin.loadAnimation({
	container: document.getElementById('date_2017_2018'),
	renderer: 'svg',
	loop: true,
	autoplay: true,
	path: 'datJSON/test_date/2017_2018.json',
});